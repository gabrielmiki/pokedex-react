...
|---|---|---|---|
| ![Home screen with search and pagination](images/home_screen.PNG) | ![Type Searching](images/type_search.PNG) | ![Name Searching](images/name_search.PNG) | ![Detail view with base stats](images/deatil_screen.PNG) |
